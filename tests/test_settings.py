...
def test_duplicate_style(tmp_path_factory):
    ...
    original.lora_presets = {"baseline": [{"name": "lora", "strength": 1.0, "enabled": True}]}
    ...
    assert copy.lora_presets == original.lora_presets
    ...
    copy.lora_presets["baseline"][0]["strength"] = 0.5
